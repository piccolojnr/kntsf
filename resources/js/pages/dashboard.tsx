...
function ReportFilterBar({
    ...
    return (
        <form
            className="flex flex-col gap-3 rounded-xl border border-app-border bg-app-surface p-3 shadow-[0_8px_24px_rgba(23,33,27,0.04)] md:flex-row md:items-end"
            onSubmit={(event) => {
                event.preventDefault();
                submit(event.currentTarget);
            }}
        >
            <div className="flex items-center gap-3 px-1 md:min-w-52">
                ...
                <div>
                    ...
                    <p className="mt-0.5 text-sm font-semibold text-app-ink">
                        {activeDetail}
                    </p>
                </div>
            </div>
            ...
            <label className="grid flex-1 gap-1.5">
                ...
                <Select value={period} onValueChange={setPeriod}>
                    <SelectTrigger className="h-10 rounded-lg border-app-border bg-app-surface-muted text-sm font-semibold text-app-ink">
            ...
            <div className="flex flex-1 gap-2">
                ...
                {['current_month', 'current_year', 'all'].includes(period) && (
                    <div className="hidden items-center gap-2 self-end rounded-lg bg-app-surface-muted px-3 text-sm text-app-muted sm:flex">
            ...
            <button
                type="submit"
                className="theme-primary-active h-10 rounded-lg px-5 text-sm font-semibold transition hover:bg-app-red"
            >
                Apply
            </button>
        </form>
    ...
    return (
        <label className="grid flex-1 gap-1.5">
            ...
            <input
                ...
                type="date"
                defaultValue={value ?? ''}
                className="h-10 min-w-0 rounded-lg border border-app-border bg-app-surface-muted px-2 text-sm font-semibold text-app-ink"
            />
        </label>
    );
}
