...
export default function MobileAppAccountReady() {
    const { auth, status } = usePage<
        SharedPageProps & { status?: string }
    >().props;

    return (
        <main className="min-h-screen bg-app-page text-app-ink">
            ...
            <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col px-5 py-8">
                ...
                <section className="grid flex-1 place-items-center py-16">
                    <div className="w-full max-w-2xl border border-app-border bg-app-surface p-6 shadow-[10px_10px_0_var(--app-ink)] md:p-10 dark:shadow-[10px_10px_0_var(--app-brass)]">
                        <div className="mb-8 flex items-start gap-4">
                            ...
                            <div>
                                <p className="text-xs font-black uppercase tracking-[0.22em] text-app-red">
                                    Account ready
                                </p>
                        ...
                        <div className="mt-8 grid gap-3 rounded-md border border-app-border bg-app-surface-muted p-4 text-sm text-app-muted">
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                            <Button asChild className="h-11">
                                <Link href={home()}>Return to public portal</Link>
                            </Button>
