...
const styles: Record<string, string> = {
    pending: 'border-app-border theme-surface text-app-muted',
    awaiting_payment: 'border-app-brass/50 bg-app-brass/15 text-app-ink',
    paid: 'border-app-ink/15 theme-ink-soft text-app-ink',
    issued: 'border-app-green/40 bg-app-green/10 text-app-green',
    failed: 'border-app-red/40 bg-app-red/10 text-app-red',
    cancelled: 'border-app-border theme-surface text-app-muted',
    expired: 'border-app-border theme-surface text-app-muted',
};
